...
const landingPageTxt = {
  font: 'monts',
  tarString: 'At my core, I am a constant asker of why? and how did you do that?. On the outside, I use React.js, jQuery, Express.js, PostgreSQL, Python, and more to create web- based applications.I am actively looking for opportunities that allow me to learn everyday and improve in what I know.',
  bold: ['why?', 'how', 'did', 'you', 'do', 'that?.', 'React.js,', 'jQuery,', 'Express.js,', 'PostgreSQL,', 'Python,']
}

const landingPageHeading = {
  font='pfDisp'
  tarString="I build intelligent and impactful applications that work."
  ...
  return (
    <>
      ...
      >
        ...
        bold={['why?', 'how', 'did', 'you', 'do', 'that?.', 'React.js,', 'jQuery,', 'Express.js,', 'PostgreSQL,', 'Python,']}/> */}
        <Typewriter items={[landingPageHeading,landingPageTxt]} />
      </ParallaxLayer>
    </>
  )
}
