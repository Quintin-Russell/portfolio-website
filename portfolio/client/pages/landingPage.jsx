      ...
      <Parallax pages={1.5}>
        ...
        >
          <div css={layout.margin1rem}>
            <div css={(!lessThan768) ? [...jobDesc, style.font3rem] : [...jobDesc, style.font2halfrem]}>
            ...
            <div css={(!lessThan768) ? [...jobDesc, style.font3rem, style.landingPgTxt_or] : [...jobDesc, style.font2halfrem, style.landingPgTxt_or]}>
              {`>`}
            </div>
          ...
          <Typewriter
            font='pfDisp'
            fontSize={(!lessThan768) ? 'font3rem' : 'font2halfrem'}
            tarString="
          ...
          <div css={(!lessThan768) ? [...jobDesc, layout.margin1rem, style.font3rem] : [...jobDesc, layout.margin1rem, style.font2halfrem]}>
