      ...
      <Parallax pages={4.75}>
        ...
        <ParallaxLayer speed={0.5} factor={1.2}>
          ...
          >
            ...
            <div
              css={[...col50Cont, layout.marginAuto, layout.smallSidePadding]}
            >
              <Typewriter
                font="pfDisp"
                fontSize="font3rem"
          ...
          >
            <div css={[...col50Cont, style.textCent]}>
              <p css={[...endText, layout.margin0]}>
                Do you have an idea of what you want to create? <br />A new
                feature for your website? A new way for your clients to
                communicate with you? I would love to help out in the design and
                build process.
              </p>
              <p css={endText}>
                Click the link and let's make your idea a reality!
              </p>
            </div>
